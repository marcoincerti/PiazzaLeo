...
class SeminariPage extends StatefulWidget {
  final FirebaseAuth auth;

  const SeminariPage({Key key, this.auth}) : super(key: key);

  @override
  _SeminariPageState createState() => _SeminariPageState();
}

class _SeminariPageState extends State<SeminariPage> {
